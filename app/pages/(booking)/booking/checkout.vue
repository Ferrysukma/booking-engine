...
<template>
  <div>
            ...
            <div v-for="(item) in guestState" :key="item.id" class="border border_theme rounded-lg p-2">
              ...
              <div v-for="detail in item.details" :key="detail.id">
                <div class="relative flex pb-5 items-center">
                  ...
                  <span class="shrink mx-4 text_theme border border_theme text-sm rounded-lg px-3 py-1 ">{{ detail.name
                  }}</span>
                  <div class="grow border-t border-gray-400"></div>
                </div>
                <div class="flex flex-wrap md:flex-row md:align-middle space-x-3 space-y-2 mb-3 md:mb-0">
                  <!-- <div class="w-full md:w-auto mb-3 md:mb-0">
                    <label class="text_theme border border_theme rounded-lg px-3 py-1 text-sm font-base md:mr-6">{{
                      detail.name
                    }}</label>
                  </div> -->
          ...
          <div class="flex flex-col space-x-2 mb-8 w-full">
              ...
              <table class="w-full">
                <tbody>
                  <tr v-for="detail in cart.details" :key="detail.id">
                    <th class="py-1 w-[60%] text-green-500 font-medium text-[13px] text-start">{{ detail.name }}</th>
                    <th class="py-1 w-[40%] text-amber-950 font-semibold text-[13px] text-end">IDR {{
                      formatPrice(detail.price) }}</th>
                  </tr>
                  <tr>
                    <th class="py-1 w-[60%] text-slate-800 font-bold text-[13px] text-start">Subtotal</th>
                    <th class="py-1 w-[40%] text-slate-800 font-bold text-[13px] text-end">IDR {{
            ...
            <div class="flex flex-col space-y-2 border-b border-default mb-2 pb-3">
              <table class="w-full">
                <tbody>
                  <tr>
                    <th class="py-1 w-[60%] text-slate-800 font-bold text-[13px] text-start">Total</th>
                    <th class="py-1 w-[40%] text-slate-800 font-bold text-[13px] text-end">IDR {{
    ...
    <FragmentModal title="Payment Method">
