        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="#" class="flex ms-2 md:me-24">
              <NuxtImg src="https://flowbite.com/docs/images/logo.svg" class="h-6 me-3" alt="Flowbite Logo" />
              <span class="self-center text-lg font-semibold whitespace-nowra">Booking Engine</span>
            </a>
          </div>
          <div class="flex items-center">
              <div class="flex items-center ms-3">
                ...
                <div id="dropdown-user" class="z-50 hidden bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44">
            ...
            <li>
              ...
              <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                      ...
                      <li>
                          <a type="button" class="pl-10 flex items-center justify-between px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group cursor-pointer" aria-controls="dropdown-example-3" data-collapse-toggle="dropdown-example-3">
                            Level 3
                            <div class="pr-8">
                              <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9-7 7-7-7"/></svg>
                            </div>
                          </a>
                          <ul id="dropdown-example-3" class="hidden py-4 space-y-4">
                            <li>
                                <a href="#" class="pl-15 flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">Items</a>
                              </li>
                          </ul>
                      </li>
                </ul>
